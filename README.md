...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573307216.4fe35a8a34bf.219.657.v2
	new:                tensorboard/train/events.out.tfevents.1573307219.4fe35a8a34bf.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_13-46-59/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573307253.4fe35a8a34bf.219.48465.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.02173432168542926 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 2 --average-kernels 77 --num-of-conv-layers 6 --kernel-increasing-factor 1.2768284283784372 --maxpool-after-n-layer 4 --dropout-factor-after-conv 0.04196454453828646 --dropout-factor-after-maxp 0.01
