...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573289060.01eaace4cebd.219.595.v2
	new:                tensorboard/train/events.out.tfevents.1573289064.01eaace4cebd.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_08-44-24/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573289105.01eaace4cebd.219.45327.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.0832246720117252 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 6 --average-kernels 48 --num-of-conv-layers 5 --kernel-increasing-factor 1.202501838041888 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.04140427157857095 --dropout-factor-after-maxp 0.01
