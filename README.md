...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573266496.655de724f593.219.355.v2
	new:                tensorboard/train/events.out.tfevents.1573266498.655de724f593.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_02-28-18/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573266510.655de724f593.219.33663.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.08470673967746627 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 4 --average-kernels 62 --num-of-conv-layers 1 --kernel-increasing-factor 1.3502835469990513 --maxpool-after-n-layer 3 --dropout-factor-after-conv 0.22566957079837308 --dropout-factor-after-maxp 0.01
