...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573292306.703bb926249f.219.355.v2
	new:                tensorboard/train/events.out.tfevents.1573292307.703bb926249f.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_09-38-27/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573292319.703bb926249f.219.33663.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.019666092815018747 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 4 --average-kernels 62 --num-of-conv-layers 1 --kernel-increasing-factor 1.3502835469990513 --maxpool-after-n-layer 3 --dropout-factor-after-conv 0.22566957079837308 --dropout-factor-after-maxp 0.01
