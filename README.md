...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573314086.7a7e924a3804.220.597.v2
	new:                tensorboard/train/events.out.tfevents.1573314093.7a7e924a3804.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_15-41-33/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573314193.7a7e924a3804.220.45549.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.05501339886993021 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 6 --average-kernels 106 --num-of-conv-layers 5 --kernel-increasing-factor 0.8472487976219152 --maxpool-after-n-layer 3 --dropout-factor-after-conv 0.09674060082484426 --dropout-factor-after-maxp 0.01
