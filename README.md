...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573303512.b06c99643e7c.219.537.v2
	new:                tensorboard/train/events.out.tfevents.1573303515.b06c99643e7c.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_12-45-15/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573303533.b06c99643e7c.219.42633.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.002546213815307713 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 6 --average-kernels 36 --num-of-conv-layers 4 --kernel-increasing-factor 1.367284864080131 --maxpool-after-n-layer 3 --dropout-factor-after-conv 0.08311235459203768 --dropout-factor-after-maxp 0.01
