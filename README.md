...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573265988.0cdd47ac92a1.223.357.v2
	new:                tensorboard/train/events.out.tfevents.1573265990.0cdd47ac92a1.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_02-19-50/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573266004.0cdd47ac92a1.223.33885.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.004308004078148728 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 2 --average-kernels 26 --num-of-conv-layers 1 --kernel-increasing-factor 1.5107436054649497 --maxpool-after-n-layer 1 --dropout-factor-after-conv 0.2765271416813163 --dropout-factor-after-maxp 0.01
