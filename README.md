...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573268999.b96fbb803d1a.220.475.v2
	new:                tensorboard/train/events.out.tfevents.1573269001.b96fbb803d1a.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_03-10-01/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573269020.b96fbb803d1a.220.39495.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.03834460773884812 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 5 --average-kernels 34 --num-of-conv-layers 3 --kernel-increasing-factor 1.2378785339945304 --maxpool-after-n-layer 5 --dropout-factor-after-conv 0.11475904771740232 --dropout-factor-after-maxp 0.01
