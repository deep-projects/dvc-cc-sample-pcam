...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573308342.e6f0470041e7.219.605.v2
	new:                tensorboard/train/events.out.tfevents.1573308345.e6f0470041e7.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_14-05-45/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573308365.e6f0470041e7.219.46437.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.007081945374371559 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 6 --average-kernels 123 --num-of-conv-layers 5 --kernel-increasing-factor 1.0343149208016118 --maxpool-after-n-layer 1 --dropout-factor-after-conv 0.0516077526772949 --dropout-factor-after-maxp 0.01
