...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573325952.74ecb4cad1e1.219.543.v2
	new:                tensorboard/train/events.out.tfevents.1573325955.74ecb4cad1e1.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_18-59-15/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573325976.74ecb4cad1e1.219.43299.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.004682233781382967 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 4 --average-kernels 116 --num-of-conv-layers 4 --kernel-increasing-factor 0.9369641460763412 --maxpool-after-n-layer 1 --dropout-factor-after-conv 0.1417187279371753 --dropout-factor-after-maxp 0.01
