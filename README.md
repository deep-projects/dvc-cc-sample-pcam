...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573304795.0cf87e59e349.219.605.v2
	new:                tensorboard/train/events.out.tfevents.1573304798.0cf87e59e349.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_13-06-38/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573304811.0cf87e59e349.219.46437.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.002546213815307713 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 7 --average-kernels 112 --num-of-conv-layers 5 --kernel-increasing-factor 1.3452280782213475 --maxpool-after-n-layer 1 --dropout-factor-after-conv 0.04378164431221054 --dropout-factor-after-maxp 0.01
