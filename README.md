...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573291555.70c377d0c9bc.220.661.v2
	new:                tensorboard/train/events.out.tfevents.1573291557.70c377d0c9bc.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_09-25-57/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573291569.70c377d0c9bc.220.48909.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.0832246720117252 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 3 --average-kernels 27 --num-of-conv-layers 6 --kernel-increasing-factor 0.9984750481776846 --maxpool-after-n-layer 2 --dropout-factor-after-conv 0.07185367690346123 --dropout-factor-after-maxp 0.01
