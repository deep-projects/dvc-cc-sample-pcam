...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573307568.847e246756c5.219.605.v2
	new:                tensorboard/train/events.out.tfevents.1573307570.847e246756c5.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_13-52-50/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573307583.847e246756c5.219.46437.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.02173432168542926 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 5 --average-kernels 115 --num-of-conv-layers 5 --kernel-increasing-factor 1.2768238821914673 --maxpool-after-n-layer 1 --dropout-factor-after-conv 0.08312908187601069 --dropout-factor-after-maxp 0.01
