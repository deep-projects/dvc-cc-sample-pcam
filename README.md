...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573286047.f4c0766bbb89.219.355.v2
	new:                tensorboard/train/events.out.tfevents.1573286049.f4c0766bbb89.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_07-54-09/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573286059.f4c0766bbb89.219.33663.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.049504524720929526 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 4 --average-kernels 35 --num-of-conv-layers 1 --kernel-increasing-factor 1.384877704840008 --maxpool-after-n-layer 4 --dropout-factor-after-conv 0.13598160493709044 --dropout-factor-after-maxp 0.01
