...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573278718.d6c6f5be9d8c.219.355.v2
	new:                tensorboard/train/events.out.tfevents.1573278720.d6c6f5be9d8c.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_05-52-00/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573278733.d6c6f5be9d8c.219.33663.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.002749831401097266 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 3 --average-kernels 104 --num-of-conv-layers 1 --kernel-increasing-factor 1.491883634511352 --maxpool-after-n-layer 5 --dropout-factor-after-conv 0.092155006450024 --dropout-factor-after-maxp 0.01
