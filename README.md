...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573263880.cad94c4d41b1.220.599.v2
	new:                tensorboard/train/events.out.tfevents.1573263883.cad94c4d41b1.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_01-44-43/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573263908.cad94c4d41b1.220.45771.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.01 --batch-size 128 --num-of-epochs 10 --activation-function relu --kernel-width 3 --average-kernels 128 --num-of-conv-layers 5 --kernel-increasing-factor 1.4 --maxpool-after-n-layer 2 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.1
