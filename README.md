...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573315380.db5f0426848f.219.415.v2
	new:                tensorboard/train/events.out.tfevents.1573315384.db5f0426848f.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_16-03-04/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573315419.db5f0426848f.219.36579.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.05501339886993021 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 5 --average-kernels 119 --num-of-conv-layers 2 --kernel-increasing-factor 0.9838335369391727 --maxpool-after-n-layer 4 --dropout-factor-after-conv 0.2562594162050576 --dropout-factor-after-maxp 0.01
