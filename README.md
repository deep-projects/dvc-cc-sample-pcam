...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573301165.9fa2098475f4.219.475.v2
	new:                tensorboard/train/events.out.tfevents.1573301167.9fa2098475f4.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_12-06-07/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573301185.9fa2098475f4.219.39495.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.025111788601243325 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 5 --average-kernels 34 --num-of-conv-layers 3 --kernel-increasing-factor 1.2378785339945304 --maxpool-after-n-layer 5 --dropout-factor-after-conv 0.11475904771740232 --dropout-factor-after-maxp 0.01
