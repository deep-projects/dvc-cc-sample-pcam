...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573297573.ceab33634c05.219.657.v2
	new:                tensorboard/train/events.out.tfevents.1573297576.ceab33634c05.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_11-06-16/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573297605.ceab33634c05.219.48465.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.025111788601243325 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 3 --average-kernels 46 --num-of-conv-layers 6 --kernel-increasing-factor 1.1037451880037745 --maxpool-after-n-layer 5 --dropout-factor-after-conv 0.04804849190890336 --dropout-factor-after-maxp 0.01
