...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573310277.30139e4288df.219.605.v2
	new:                tensorboard/train/events.out.tfevents.1573310279.30139e4288df.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_14-37-59/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573310290.30139e4288df.219.46437.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.007081945374371559 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 5 --average-kernels 65 --num-of-conv-layers 5 --kernel-increasing-factor 1.438843614650403 --maxpool-after-n-layer 1 --dropout-factor-after-conv 0.0979619302714976 --dropout-factor-after-maxp 0.01
