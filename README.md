...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573265985.54c1a1c7d9e3.222.661.v2
	new:                tensorboard/train/events.out.tfevents.1573265987.54c1a1c7d9e3.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_02-19-47/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573266001.54c1a1c7d9e3.222.48909.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.08470673967746627 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 3 --average-kernels 27 --num-of-conv-layers 6 --kernel-increasing-factor 0.9984750481776846 --maxpool-after-n-layer 2 --dropout-factor-after-conv 0.07185367690346123 --dropout-factor-after-maxp 0.01
