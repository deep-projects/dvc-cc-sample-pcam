...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573266614.ee8199c55c60.219.605.v2
	new:                tensorboard/train/events.out.tfevents.1573266616.ee8199c55c60.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_02-30-16/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573266628.ee8199c55c60.219.46437.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.004308004078148728 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 5 --average-kernels 37 --num-of-conv-layers 5 --kernel-increasing-factor 1.0093848113875588 --maxpool-after-n-layer 1 --dropout-factor-after-conv 0.15013377796380795 --dropout-factor-after-maxp 0.01
