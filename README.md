...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573266590.f9bd6dad6c2b.219.595.v2
	new:                tensorboard/train/events.out.tfevents.1573266594.f9bd6dad6c2b.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_02-29-54/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573266637.f9bd6dad6c2b.219.45327.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.01616429932898008 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 6 --average-kernels 48 --num-of-conv-layers 5 --kernel-increasing-factor 1.202501838041888 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.04140427157857095 --dropout-factor-after-maxp 0.01
