...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573312625.085a3277114b.219.355.v2
	new:                tensorboard/train/events.out.tfevents.1573312627.085a3277114b.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_15-17-07/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573312640.085a3277114b.219.33663.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.06792525055933071 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 3 --average-kernels 104 --num-of-conv-layers 1 --kernel-increasing-factor 1.491883634511352 --maxpool-after-n-layer 5 --dropout-factor-after-conv 0.092155006450024 --dropout-factor-after-maxp 0.01
