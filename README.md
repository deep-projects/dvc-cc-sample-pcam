...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573281460.2936259ecffb.219.539.v2
	new:                tensorboard/train/events.out.tfevents.1573281462.2936259ecffb.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_06-37-42/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573281483.2936259ecffb.219.42855.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.01549217922009153 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 5 --average-kernels 43 --num-of-conv-layers 4 --kernel-increasing-factor 0.8205307215719769 --maxpool-after-n-layer 2 --dropout-factor-after-conv 0.1243667410155975 --dropout-factor-after-maxp 0.01
