...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573312319.e3985e3492db.220.537.v2
	new:                tensorboard/train/events.out.tfevents.1573312322.e3985e3492db.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_15-12-02/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573312346.e3985e3492db.220.42633.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.06792525055933071 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 3 --average-kernels 49 --num-of-conv-layers 4 --kernel-increasing-factor 1.1019176955667314 --maxpool-after-n-layer 4 --dropout-factor-after-conv 0.0919773859601739 --dropout-factor-after-maxp 0.01
