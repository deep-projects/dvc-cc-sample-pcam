...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573280381.98f2a9dd1bf3.219.597.v2
	new:                tensorboard/train/events.out.tfevents.1573280389.98f2a9dd1bf3.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_06-19-49/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573280490.98f2a9dd1bf3.219.45549.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.002749831401097266 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 6 --average-kernels 106 --num-of-conv-layers 5 --kernel-increasing-factor 0.8472487976219152 --maxpool-after-n-layer 3 --dropout-factor-after-conv 0.09674060082484426 --dropout-factor-after-maxp 0.01
