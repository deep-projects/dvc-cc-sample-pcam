...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573297132.203904cba61b.220.537.v2
	new:                tensorboard/train/events.out.tfevents.1573297137.203904cba61b.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_10-58-57/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573297191.203904cba61b.220.42633.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.017652415153180168 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 5 --average-kernels 86 --num-of-conv-layers 4 --kernel-increasing-factor 0.9078690631667409 --maxpool-after-n-layer 4 --dropout-factor-after-conv 0.07175080301064515 --dropout-factor-after-maxp 0.01
