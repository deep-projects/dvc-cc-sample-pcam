...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573280129.9d4b5a7e81fa.220.415.v2
	new:                tensorboard/train/events.out.tfevents.1573280132.9d4b5a7e81fa.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_06-15-32/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573280168.9d4b5a7e81fa.220.36579.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.01549217922009153 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 5 --average-kernels 119 --num-of-conv-layers 2 --kernel-increasing-factor 0.9838335369391727 --maxpool-after-n-layer 4 --dropout-factor-after-conv 0.2562594162050576 --dropout-factor-after-maxp 0.01
