...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573322654.9f9341ceeb0b.219.417.v2
	new:                tensorboard/train/events.out.tfevents.1573322656.9f9341ceeb0b.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_18-04-16/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573322672.9f9341ceeb0b.219.36801.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.04187860392549707 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 2 --average-kernels 80 --num-of-conv-layers 2 --kernel-increasing-factor 1.4913893227784762 --maxpool-after-n-layer 2 --dropout-factor-after-conv 0.17950068266565672 --dropout-factor-after-maxp 0.01
