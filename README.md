...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573272938.20716d41545f.220.657.v2
	new:                tensorboard/train/events.out.tfevents.1573272941.20716d41545f.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_04-15-41/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573272977.20716d41545f.220.48465.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.0521440802345861 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 2 --average-kernels 77 --num-of-conv-layers 6 --kernel-increasing-factor 1.2768284283784372 --maxpool-after-n-layer 4 --dropout-factor-after-conv 0.04196454453828646 --dropout-factor-after-maxp 0.01
