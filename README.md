...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573294805.679bae4f6ffc.220.357.v2
	new:                tensorboard/train/events.out.tfevents.1573294807.679bae4f6ffc.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_10-20-07/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573294818.679bae4f6ffc.220.33885.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.017652415153180168 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 2 --average-kernels 26 --num-of-conv-layers 1 --kernel-increasing-factor 1.5107436054649497 --maxpool-after-n-layer 1 --dropout-factor-after-conv 0.2765271416813163 --dropout-factor-after-maxp 0.01
