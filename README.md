...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573321550.fba501a04097.219.477.v2
	new:                tensorboard/train/events.out.tfevents.1573321553.fba501a04097.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_17-45-53/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573321570.fba501a04097.219.39717.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.006122776541163497 --batch-size 128 --num-of-epochs 200 --activation-function tanh --kernel-width 2 --average-kernels 61 --num-of-conv-layers 3 --kernel-increasing-factor 0.9645683085327015 --maxpool-after-n-layer 2 --dropout-factor-after-conv 0.031475352461531235 --dropout-factor-after-maxp 0.01
