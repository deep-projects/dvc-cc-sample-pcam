...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1573275129.006f12e72bf0.219.605.v2
	new:                tensorboard/train/events.out.tfevents.1573275131.006f12e72bf0.profile-empty
	new:                tensorboard/train/plugins/profile/2019-11-09_04-52-11/local.trace
	new:                tensorboard/validation/events.out.tfevents.1573275142.006f12e72bf0.219.46437.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.0551532239408325 --batch-size 128 --num-of-epochs 200 --activation-function relu --kernel-width 5 --average-kernels 65 --num-of-conv-layers 5 --kernel-increasing-factor 1.438843614650403 --maxpool-after-n-layer 1 --dropout-factor-after-conv 0.0979619302714976 --dropout-factor-after-maxp 0.01
